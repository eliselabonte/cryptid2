    ...
    return  (
        <div className='category-container'>
            <div className='category-card'>
                ...
                <button id="cryptid-button" className='category-button'>Reports</button>
            </div>
            <div className='category-card'>
                <h3 className='category-name'>UFO</h3>
                <h4 className='pronounce'>\ ˌyü-(ˌ)ef-ˈō</h4>
                <p className='define'>UNIDENTIFIED FLYING OBJECT</p>
                <button id="ufo-button" className='category-button'>Reports</button>
            </div>
            <div className='category-card'>
                ...
                <button id="paranormal-button" className='category-button'>Reports</button>
            </div>
            <div className='category-card'>
                ...
                <button id="other-button" className='category-button'>Reports</button>
            </div>
        </div>
    )
}
